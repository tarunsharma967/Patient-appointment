...
<html lang="en">
  ...
  <img class="card-img-top img-responsive img-thumbnail" src="upload/<?php echo $row['image'] ?>" alt="Card image" style="height: 320px;width: 320px;">
  <div class="card-body">
    <h4 class="card-title" align="center" style="color:white"><?php echo $row['servicename'] ?></h4>
    <a href="home_service_desc.php?id=<?php echo $row['id'] ?>" class="btn btn-success" align="center">View Service</a>
  </div>
</div>
</div>
</div>
